...
class TestScanResult:
    ...
    def test_default_values(self):
        """Test default values."""
        result = ScanResult(category="Test Category", size_bytes=1024, count=5)
    ...
    def test_with_items(self):
        ...
        result = ScanResult(category="Temp Files", size_bytes=2048, count=2, items=items)
...
class TestCleanupScanner:
    ...
    def test_scan_all_returns_list(self, scanner):
        ...
        with (
            patch.object(scanner, "scan_package_cache") as mock_pkg,
