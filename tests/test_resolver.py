...
class TestDependencyResolver(unittest.TestCase):
    ...
    def test_basic_conflict_resolution(self) -> None:
        """Test basic conflict resolution returns expected recommended strategies."""
        conflict = {
            "dependency": "lib-x",
    ...
    def test_risk_calculation_low(self) -> None:
        ...
        strategies = self.resolver.resolve(conflict)
        self.assertEqual(strategies[0]["risk"], "Low (no breaking changes detected)")

    def test_complex_constraint_formats(self) -> None:
        """Test various semver constraint syntaxes to ensure parser stability."""
        test_cases = [
